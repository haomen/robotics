...
\documentclass{elsart}%\usepackage{elsart}%%Automatica-----System and control letters

 \newenvironment{proof}{\emph{Proof:}}{\hspace{\stretch{1}}\rule{1ex}{1ex}}   %%%EEEAutomatica
             \newtheorem{theorem}{Theorem}%[section]                                       %%%EEEAutomatica
             \newtheorem{definition}{Definition}                                          %%%EEEAutomatica
             \newtheorem{lemma}{Lemma}                                                    %%%EEEAutomatica
             \newtheorem{remark}{Remark}                                                  %%%EESCL SCL SCL
             \newtheorem{corollary}{Corollary}                                            %%%EESCL SCL SCL
             \newtheorem{example}{Example}                                                %%%EESCL SCL SCL
             \usepackage{harvard}                                                         %%%EESCL SCL
%\documentclass{elsarticle}
%\documentclass{autart}\usepackage{elsart}
%%%%1. 先选取期刊中的一个%%%%%'
%%%%2. 在转换了期刊后,运行Latex时,可能报错. 可先运行一次 "Erase Working Files"(工具栏第一行:带回收站图标的按钮).
...
\author{Shuai Li $^a$, Feng Qin  $^b$}


\address{Department of Electrical and Computer Engineering, Stevens Institute of Technology, Hoboken, NJ 07030, USA.}

\address{$^b$ School of Computer Science, Anhui University of Technology, Ma'anshan, Anhui, China.}
 




\thanks{Email Address: lshuai@stevens.edu (Shuai Li), fqin@ahut.edu.cn (Feng Qin).
}
